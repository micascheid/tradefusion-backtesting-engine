...
class KrownCrossBoth(Strategy):
    ...
    def next(self):
        ...
        is_take_profit = (self.long_hold == 1 and self.bbwp_hit_counter == self.bbwp_hit_exit) or (self.short_hold == 1 and
                                                                               self.bbwp_hit_counter == self.bbwp_hit_exit)
